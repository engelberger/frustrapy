    ...
    for res in ch:
        ...
        if (res_id==' ' or res_id=='H_MSE' or res_id=='H_M3L' or res_id=='H_CAS') and is_regular_res:
            ...
            if resname != 'GLY':
                ...
                iatom = iatom + 1
                # P0-2: the GLY H-Beta x-coordinate must be the N/CA/C interpolation
                # (xyz_H[0]), not the raw N.x (xyz_N[0]) — the latter corrupts AWSEM
                # geometry for every glycine on the live calc path.
